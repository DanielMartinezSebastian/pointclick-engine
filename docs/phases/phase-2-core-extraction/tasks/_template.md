# Task NN: <Título imperativo, ej: "Extract pathfinding to engine-core">

**Phase**: 2 | **Estimate**: <Xh> | **Owner**: <- | nombre>
...
2. Commit:
   ...
   See docs/phases/phase-2-core-extraction/tasks/NN-<task-slug>.md
   ```
