...
describe("usePlayerWalkAnimation", () => {
    ...
    describe("walk state validity", () => {
        ...
        test("walk state must track isActive", () => {
            const walkActiveState = {
                targetPosition: [5, 0, 10],
                pathPoints: [[0, 0, 0], [5, 0, 10]],
                progress: 0.5,
                isActive: true,
            };
            const walkInactiveState = {
                targetPosition: [5, 0, 10],
                pathPoints: [[0, 0, 0], [5, 0, 10]],
                progress: 0,
                isActive: false,
...
//# sourceMappingURL=usePlayerWalkAnimation.test.js.map