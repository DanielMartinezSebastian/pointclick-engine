...
import { resolveAudioEvents, } from "@pointclick-engine/engine-core";
export function useAudioSystem(opts) {
    const previousMusicRef = useRef(undefined);
    useEffect(() => {
...
//# sourceMappingURL=useAudioSystem.js.map